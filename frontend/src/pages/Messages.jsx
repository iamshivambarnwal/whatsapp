      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-800">
            {loadingMessages && <tr><td colSpan={4} className="px-4 py-8 text-center text-gray-600 text-xs">Loading...</td></tr>}
            {!loadingMessages && messages.length === 0 && <tr><td colSpan={4} className="px-4 py-8 text-center text-gray-600 text-xs">No messages yet</td></tr>}
            {messages.map(m => (
